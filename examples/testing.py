...
if __name__ == '__main__':
    ...
    gov_gk = import_data( path = "data_set/government", elliptical_curve_encryption_secret_key = gk, print_label="NONE" )
    # print( "\n\n" + str( gov_gk ) )
    ...
    # 2: Simple Hasing
    gov_sh = simple_hasing( dataset = gov_sigm )
    # print( "\n\n" + str( gov_sh ) )
    ...
    bak_bk = import_data( path = "data_set/bank", elliptical_curve_encryption_secret_key = bk, print_label="NONE" )
    # print( "\n\n" + str( bak_bk ) )
    ...
    # 2: cuckoo hasing
    bak_ch = cuckoo_hashing( dataset = bak_sig )
    # print( "\n\n" + str( bak_ch ) )
    ...
    # #  Bank
    # # ##############################
    # find_intersection( gov_bak_poly_eval, bak_ch )